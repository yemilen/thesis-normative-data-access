...
class HospitalMember(override val dossier: MemberDossier, override val session: ISession) : IMemberDossierTemplatePIP {
    ...
    fun isHospitalAdmin(email: String): Boolean = email in (dossier.data["admins"] as List<String>? ?: emptyList())
